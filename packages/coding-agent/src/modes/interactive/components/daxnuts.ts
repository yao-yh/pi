/**
 * 由 DAXNUTS 驱动——OpenCode + Kimi K2.5 彩蛋
 *
 * 谨向通过 OpenCode 免费提供 Kimi K2.5 访问能力的 dax（@thdxr）致意。
 */

import type { Component, TUI } from "@earendil-works/pi-tui";
import { theme } from "../theme/theme.ts";

// dax 的 32x32 RGB 图像，采用十六进制编码（每像素 3 字节）
const DAX_HEX =
...
export class DaxnutsComponent implements Component {
	...
	private tick = 0;
	private maxTicks = 25; // 按 80ms 计时约为 2 秒
